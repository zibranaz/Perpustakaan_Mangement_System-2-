...
public class AuthorList extends javax.swing.JFrame {
    ...
    public boolean deleteBook() {
        ...
        try {
            Connection con = DBConnection.getConnection();
            String sql = "delete from author_list where author_id = ?";
            PreparedStatement pst = con.prepareStatement(sql);
            pst.setInt(1, author_id);
    ...
    private void searchBook() {
        ...
        try (Connection con = DBConnection.getConnection()) {
            String sql = "SELECT * FROM author_list WHERE book_name LIKE ? OR author LIKE ?";
            PreparedStatement pst = con.prepareStatement(sql);
...
//method to clear table
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 630, 130, 40));
        ...
        jPanel1.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 630, 130, 40));
        ...
        jPanel1.add(search, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 630, 130, 40));
